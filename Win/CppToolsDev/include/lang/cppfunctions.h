 ...
 * @param str
 */
CPP_TOOLS_API void vector2str(std::vector<unsigned int> theVec, char* str);
 ...
 * @param str
 */
CPP_TOOLS_API void list2str(std::list<unsigned int> theList, char* str);
 ...
 * @param v
 */
CPP_TOOLS_API void charvet2type(const char* vetc, unsigned int& v);
 ...
 * @param theList	an empty list in the format std::std::list<long int>
 */
CPP_TOOLS_API void charvet2type(const char* vetc, std::list<unsigned int>& theList);
...
CPP_TOOLS_API void charvet2type(const char* vetc, std::vector<unsigned int>& theVector);
